...
only_ep_filename = 'only_ep_DOE_Ref'
...
if os.path.exists(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Urban.csv')):
    urban_all_sites_10min_clean = pd.read_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Urban.csv'),
    ...
    urban_all_sites_10min_clean = plt_tools.clean_bubble_iop(urban_all_sites_10min_dirty,
                                                      ...
                                                      to_hourly= False)
    urban_all_sites_10min_clean.to_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Urban.csv'))

if os.path.exists(os.path.join(measure_results_folder, 'BUBBLE_EPW.csv')):
    Basel_epw_all_clean = pd.read_csv(os.path.join(measure_results_folder, 'BUBBLE_EPW.csv'),
                                      index_col=0, parse_dates=True)
else:
    ...
    Basel_epw_all_clean.to_csv(os.path.join(measure_results_folder, 'BUBBLE_EPW.csv'))
...
# select the 9th column, pressure as the comparison data
Basel_epw_staPre_Pa_all = Basel_epw_all_clean.iloc[:, 9]
if hourly_p0:
    if os.path.exists(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real.csv')):
        original_real_10min_c_compare = pd.read_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real.csv'),
                                                    index_col=0, parse_dates=True)
    else:
        ...
        original_potential_10min_c_compare.to_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Potential.csv'))
        original_real_10min_c_compare.to_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real.csv'))
    ...
    if os.path.exists(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real_HourlyP0.csv')):
        original_real_10min_c_compare = pd.read_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real_HourlyP0.csv'),
                                                    index_col=0, parse_dates=True)
    else:
        original_potential_10min_c_compare, original_real_10min_c_compare = \
            plt_tools.excel_to_potential_real_df(original_filename, only_vcwg_results_folder, p0,
                                                 heights_profile, ue1_heights,compare_start_time,compare_end_time)
        original_potential_10min_c_compare.to_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Potential_HourlyP0.csv'))
        original_real_10min_c_compare.to_csv(os.path.join(measure_results_folder, 'BUBBLE_Ue1_Original_Real_HourlyP0.csv'))
...
debug_only_ep_5min = pd.read_excel(f'{only_ep_results_folder}\\{only_ep_filename}_debugging_canyon.xlsx',
                                   header=0, index_col=0)
debug_only_vcwg_5min = pd.read_excel(f'{only_vcwg_results_folder}\\only_vcwg_debugging_canyon.xlsx',
                                     header=0, index_col=0)
