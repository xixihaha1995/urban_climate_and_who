...
prediction_folder_prefix = r'..\\_2_cases_input_outputs\\_05_Basel_BSPR_ue1\\MidRiseApartment_4C_Rural'
...
only_ep_filename_prefix = 'BUBBLE_Ue1_only_ep_2002_June'
only_vcwg_filename_prefix = 'BUBBLE_Ue1_Rural_only_vcwg_2002_June'
bypass_filename_prefix = 'ver1.1\\_BSPR_bypass_Albedo'
...
#save
tower_ori_10min.to_csv(os.path.join(measure_results_folder, tower_ori_filename))
...
# save
measure_tdb_c_2p6_10min.to_csv(os.path.join(measure_results_folder, 'measure_tdb_c_2p6_10min.csv'))
measure_tdb_c_13p9_10min.to_csv(os.path.join(measure_results_folder, 'measure_tdb_c_13p9_10min.csv'))
...
only_ep_degC_2p6_13p9_10min.to_csv(os.path.join(measure_results_folder, 'only_ep_degC_2p6_13p9_10min.csv'))
