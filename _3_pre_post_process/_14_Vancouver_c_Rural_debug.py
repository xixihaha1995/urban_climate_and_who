...
prediction_folder_prefix = r'..\\_2_cases_input_outputs\\_07_vancouver\\Rural_Refined_Small_Office'
...
epw_atm_filename = r'VancouverRural718920'
only_ep_filename_prefix = 'Vancouver_Rural_only_ep_2008_July'
only_vcwg_filename_prefix = 'Vancouver_Rural_only_vcwg_2008_Jul'
bypass_filename_prefix = 'ver1.1\\Vancouver_Rural_ByPass_2008Jul'
...
#add prepone time to each row
if postpone_time != 0:
    epw_staPre_Pa_all.index = epw_staPre_Pa_all.index - pd.Timedelta(hours=postpone_time)
...
if postpone_time != 0:
    debug_only_ep_5min.index = debug_only_ep_5min.index - pd.Timedelta(hours=postpone_time)
...
only_vcwg_direct_lst_C, only_vcwg_real_p0_lst_C, only_vcwg_real_epw_lst_C = \
    plt_tools.excel_to_direct_real_p0_real_epw(only_vcwg_filename_prefix, only_vcwg_folder,
                                               ...
                                               mapped_indices = selected_prediction_idx, postpone_time=postpone_time)
...
plt_tools.shared_x_plot(prediction_folder_prefix, canyon_name='1p2m Direct')