...
# save
measure_tdb_c_1p2m_30min.to_csv(os.path.join(measure_results_folder, 'measure_tdb_c_1p2m_30min.csv'))
measure_tdb_c_26m_30min.to_csv(os.path.join(measure_results_folder, 'measure_tdb_c_26m_30min.csv'))
...
only_ep_degC_1p2_26m_30min.to_csv(os.path.join(measure_results_folder, 'only_ep_degC_1p2_26m_30min.csv'))
...
debug_bypass = pd.read_excel(f'{bypass_folder}\\{bypass_filename_prefix}_debugging_canyon.xlsx',
                                header=0, index_col=0)
plt_tools.save_Vancouver_debug(measure_tdb_c_1p2m_30min,measure_tdb_c_26m_30min,
                             only_ep_degC_1p2_26m_30min,
                             only_vcwg_direct_lst_C,only_vcwg_real_p0_lst_C, only_vcwg_real_epw_lst_C,
                             bypass_direct_lst_C, bypass_real_p0_lst_C, bypass_real_epw_lst_C,
