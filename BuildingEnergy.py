...
import _0_vcwg_ep_coordination as coordination, numpy as np, os, datetime
"""
...
class Building(object):
    ...
    def BEMCalc(self,canTemp,canHum,BEM,MeteoData,ParCalculation,simTime,Geometry_m,FractionsRoof,SWR,
        ...
        sensor_heights = [int(i) for i in coordination.config['_0_vcwg_ep_coordination.py']['sensor_height_meter'].split(',')]
        vcwg_time_index_in_seconds = (it + 1) * simTime.dt

        data_saving_path = coordination.vcwg_prediction_saving_path
        ...
        if not os.path.exists(data_saving_path):
            ...
            with open(data_saving_path, 'a') as f1:
                ...
                header_str = 'cur_datetime,WallshadeT,WalllitT,RoofT,canTemp_K,rh_%,vcwg_canPress_Pa,senWaste,MeteoData.Tatm,MeteoData.Pre,'
