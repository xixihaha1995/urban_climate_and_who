...
df_30min_sens_measure = df_30min_sens_measure_all.loc['2008-05-06 00:00:00':'2008-5-10 23:00:00']

df_hourly_sens_measure = plt_tools.time_interval_convertion(df_30min_sens_measure)


plt_tools.plot_comparison_measurement_simulated(df_hourly_sens_measure, df_hourly_sens_measure, 'Bypass')
