...
all_df_names = ['measurements_hour', 'replicate_profile_hours_height']
all_df = [measurements_hour_K, replicate_profile_hours_height]
...
error_info = [bias_rmse_r2_th_rep]
plt_tools.plot_comparison_measurement_simulated(all_in_one_df,error_info)
