...
def _nested_ep_then_vcwg(state):
    global one_time,one_time_call_vcwg,\
        ...
        gsw_Text_handle, gse_office_Text_handle, gs1_Text_handle, gs2_Text_handle,\
        msw_Text_handle, mse_Text_handle, ms1_Text_handle, ms2_Text_handle,\
        tsw_Text_handle, tse_Text_handle, ts1_Text_handle, ts2_Text_handle,\
        gnw_Text_handle, gne_office_Text_handle, gn1_Text_handle, gn2_Text_handle,\
        mnw_Text_handle, mne_Text_handle, mn1_Text_handle, mn2_Text_handle,\
        tnw_Text_handle, tne_Text_handle, tn1_Text_handle, tn2_Text_handle,\
        gsw_Tint_handle, gse_office_Tint_handle, gs1_Tint_handle, gs2_Tint_handle,\
        msw_Tint_handle, mse_Tint_handle, ms1_Tint_handle, ms2_Tint_handle,\
        tsw_Tint_handle, tse_Tint_handle, ts1_Tint_handle, ts2_Tint_handle,\
        gnw_Tint_handle, gne_office_Tint_handle, gn1_Tint_handle, gn2_Tint_handle,\
        mnw_Tint_handle, mne_Tint_handle, mn1_Tint_handle, mn2_Tint_handle,\
        tnw_Tint_handle, tne_Tint_handle, tn1_Tint_handle, tn2_Tint_handle,\
        ...
        gnw_solar_handle, gne_office_solar_handle, gn1_solar_handle, gn2_solar_handle,\
    ...
    if one_time:
        ...
        floor_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state, "Surface Inside Face Temperature",
                                                                             "t GFloor S1A")
        s_wall_t_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "t SWall S1A")
        s_wall_t_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "t SWall S1A")
        s_wall_m_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "m SWall S1A")
        s_wall_m_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "m SWall S1A")
        s_wall_g_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "g SWall S1A")
        s_wall_g_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "g SWall S1A")
        n_wall_t_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "t NWall N1A")
        n_wall_t_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "t NWall N1A")
        n_wall_m_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "m NWall N1A")
        n_wall_m_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "m NWall N1A")
        n_wall_g_Text_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Outside Face Temperature",
                                                                                "g NWall N1A")
        n_wall_g_Tint_handle = coordination.ep_api.exchange.get_variable_handle(state,
                                                                                "Surface Inside Face Temperature",
                                                                                "g NWall N1A")
